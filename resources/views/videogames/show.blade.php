...
<div class="max-w-lg mx-auto bg-white shadow-md rounded-lg p-6 mt-16 container flex-grow content-fade flex flex-col items-center text-center">
    ...
    <div class="mb-4">
        ...
        <p id="title" class="block text-gray-700">{{ $videogames->title }}</p>
    </div>

    <div class="mb-4">
        <label for="director" class="block text-gray-700 font-bold">Studio:</label>
        <p id="director" class="block text-gray-700">{{ $videogames->studio }}</p>
    </div>

    <div class="mb-4">
        <label for="genre" class="block text-gray-700 font-bold">Genere:</label>
        <p id="genre" class="block text-gray-700">{{ $videogames->genre }}</p>
    </div>

    <div class="mb-4">
        <label for="duration" class="block text-gray-700 font-bold">Puntuació (sobre 10):</label>
        <p id="duration" class="block text-gray-700">{{ $videogames->rating }}</p>
    </div>

    <div class="mb-4">
        <label for="year" class="block text-gray-700 font-bold">Any d'estrena:</label>
        <p id="year" class="block text-gray-700">{{ $videogames->year }}</p>
    </div>
